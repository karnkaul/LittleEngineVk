...
class ListDrawer : public graphics::IDrawer {
  public:
	...
	static void add(GroupMap& out_map, DrawGroup const& group, glm::mat4 const& model, MeshView const& mesh, Rect2D scissor = {});
  ...
  protected:
	...
	virtual void draw(DescriptorBinder bind, DrawList const& list, graphics::CommandBuffer cb) const = 0;
