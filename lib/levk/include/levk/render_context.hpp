...
class RenderContext {
  public:
	...
	auto set_shadow_fragment_shader(RenderShader fragment_shader) -> bool;
  ...
  private:
	...
	void bake(RenderObject const& object);
	...
	void draw_shadows(IPipeline& pipeline, BakedObject const& object, IPrimitive const& primitive);
