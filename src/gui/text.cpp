...
namespace le::gui {
Text::Text(not_null<TreeRoot*> root, Hash fontURI) noexcept
	: TreeNode(root), m_font(findFont(fontURI)), m_fontURI(fontURI), m_textMesh(Services::get<graphics::VRAM>(), m_font) {}
